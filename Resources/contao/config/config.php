...
$GLOBALS['con4gis']['maps']['olms-version'] = 'v3.4.0';
$GLOBALS['con4gis']['maps']['ol-ext'] = 'v3.0.2';
...
$GLOBALS['con4gis']['api-caching'] = array('baseLayerService','layerService','layerContentService','locationStyleService');
