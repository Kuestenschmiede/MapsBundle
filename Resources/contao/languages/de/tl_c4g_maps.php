...
$GLOBALS['TL_LANG']['tl_c4g_maps']['filterByBaseLayer'] = ['Lokation nach Basiskarten einschalten','Wählen Sie die Basiskarten, für die diese Lokation eingeschaltet werden soll.'];
...
$GLOBALS['TL_LANG']['tl_c4g_maps']['ovp_request'] = array('Anfrage an Overpass API (XML-,QL-Format)', 'Diese Anfrage wird via AJAX browserseitig über einen Proxy (C4GOverpass.php) an die Overpass API geschickt. Doku zum Format: http://www.overpass-api.de.');
