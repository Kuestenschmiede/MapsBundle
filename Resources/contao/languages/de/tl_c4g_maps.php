...
$GLOBALS['TL_LANG']['tl_c4g_maps']['routing_to'] = array('Routenberechnung im Popup anbieten', 'Fügt Links zur Routenberechnung von, oder zu der entsprechenden Lokation in das Popup ein. Funkioniert nur, wenn im Kartenprofil die Routenberechnung aktiviert wurde.');
...
$GLOBALS['TL_LANG']['tl_c4g_maps']['split_geojson'] = array('Geojson auteilen','Hier klicken, umd die einzelnen Features eine Geojsons im Starboard schaltbar zu machen.');
...
$GLOBALS['TL_LANG']['tl_c4g_maps']['geojson_zoom'] = array('Zoombutton für GeoJson','Fügt einen Zoombutton hinzu, mit dem auf das Feld gezoomt wird');
