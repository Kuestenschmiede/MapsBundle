...
$GLOBALS['TL_LANG']['tl_c4g_map_overlays']['opacity']       = array('Initiale Sichtbarkeit', 'Initiale Sichbarkeit des Overlays in Prozent. Im Starboard anpassbar.');
...
$GLOBALS['TL_LANG']['tl_c4g_map_overlays']['geoimage_json']         = ['JSON zur Georeferenzierung', 'Bitte geben Sie hier ein <a href="https://www.json.org/">JSON</a> zur Georeferenzierung ein. Sie können dieses durch <a href="http://viglino.github.io/Map-georeferencer/">dieses Tool</a> generieren lassen oder manuell die Paramater "imageCenter", "imageRotate" und "imageScale" eintragen.'];
