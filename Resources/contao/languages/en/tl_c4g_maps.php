...
$GLOBALS['TL_LANG']['tl_c4g_maps']['tab_whereclause'] = array('Join-statement', 'Enter a join-statement, which is added to the generated SQL statement.');
...
$GLOBALS['TL_LANG']['tl_c4g_maps']['geojson_zoom'] = array('Zoombutton for geoJson','Adds a button to zoom to the feature.');
