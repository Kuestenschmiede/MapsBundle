...
//xlabel buttons
$GLOBALS['TL_LANG']['tl_content']['editLocstyles'] = ['Edit locstyles'];
$GLOBALS['TL_LANG']['tl_content']['editBaselayers'] = ['Edit baselayers'];
$GLOBALS['TL_LANG']['tl_content']['editMaps'] = ['Edit structure elements'];
