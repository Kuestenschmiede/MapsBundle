...
$GLOBALS['TL_LANG']['tl_c4g_map_themes']['effects'] = array('Effects', 'Choose a style for the effects.');
$GLOBALS['TL_LANG']['tl_c4g_map_themes']['custom_effects'] = array('Custom effects', 'Check this options, if you want to use your own CSS.');
$GLOBALS['TL_LANG']['tl_c4g_map_themes']['external_effects']  = array('Custom effects', 'Upload your own CSS-File.');
...
$GLOBALS['TL_LANG']['tl_c4g_map_themes']['popupMaxWidth'] = array('Maximum popup width', 'The maximum width of the popup (when shown as "sideboard" on the right margin). Default: 42%');
