            ...
            form =
                <form>
                    {this.props.feature.filters.map((feature, index) => {
                        return <FeatureFilterMultiCheckboxItem feature={feature} parentId={this.props.id} checked={this.props.checkedItems} filterLayers={this.props.filterLayers} key={index}/>
                    })}
                </form>
        }
        else {
