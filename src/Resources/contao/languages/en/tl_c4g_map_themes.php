...
$GLOBALS['TL_LANG']['tl_c4g_map_themes']['popupMaxWidth'] = array('Maximum sideboard width (also popup)', 'Applies to all sideboards (so also the default popup). Default: 42% (values in %, px or vw possible)');
