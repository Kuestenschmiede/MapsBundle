...
$GLOBALS['TL_LANG']['tl_c4g_maps']['locstyleWfs'] = array('Location styles for WFS', 'Select location styles corresponding to specific key/value-pairings of features.');
...
$GLOBALS['TL_LANG']['tl_c4g_maps']['media_type'] = array('Media type', 'Choose whether you want to include an audio or a video file.');
$GLOBALS['TL_LANG']['tl_c4g_maps']['map_audio_src'] = array('Audio file', 'Select an audio file (mp3, ogg, wav).');
$GLOBALS['TL_LANG']['tl_c4g_maps']['map_video_src'] = array('Video file', 'Select a video file (mp4, webm, ogv).');
$GLOBALS['TL_LANG']['tl_c4g_maps']['data_content'] = array('Data', 'Enter your data directly into this field to save it into the database. If you use the backend editor, remember to set the editor profile in the dashboard and the editor configuration in the profile.');
...
$GLOBALS['TL_LANG']['tl_c4g_maps']['references']['media']    = 'Audio or video element';
$GLOBALS['TL_LANG']['tl_c4g_maps']['references']['audio']    = 'Audio';
$GLOBALS['TL_LANG']['tl_c4g_maps']['references']['video']    = 'Video';
...
$GLOBALS['TL_LANG']['tl_c4g_maps']['locstyleWfs']['key']   = ['Key', 'Key for the property of the feature'];
$GLOBALS['TL_LANG']['tl_c4g_maps']['locstyleWfs']['compare']   = ['Compare type', 'Type for the comparison of the values    '];
$GLOBALS['TL_LANG']['tl_c4g_maps']['locstyleWfs']['value']  = ['Value', 'Corresponding value'];
