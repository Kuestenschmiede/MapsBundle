...
$GLOBALS['TL_LANG'][$strName]['drawCircle'] = ['Show radius', 'Choose whether you want to show the radius.'];
$GLOBALS['TL_LANG'][$strName]['areaCircleColor'] = ['Color of the radius', 'Choose the color of the radius and the opacity.'];
...
$GLOBALS['TL_LANG']['tl_c4g_routing_configuration']['editLocstyles'] = 'Edit locstyles';