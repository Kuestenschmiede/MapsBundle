...
$GLOBALS['TL_LANG']['tl_c4g_map_profiles']['twoFingers'] = ['Touch Navigation only with two fingers', 'Disable movement of the map with one finger'];
...
$GLOBALS['TL_LANG']['tl_c4g_map_profiles']['starboard_filter_placeholder'] = ['Starboard Filter Placeholder', 'A placholder for the starboard filter.'];
...
$GLOBALS['TL_LANG']['tl_c4g_map_profiles']['permalinkWithoutGenerator'] = ['Generate permalink automaticly', 'Generate permalink automaticly without permalink generator.'];
...
$GLOBALS['TL_LANG']['tl_c4g_map_profiles']['popupMultiple'] = ['Multiple Popups', 'Allow multiple popups simultaneously.'];
...
$GLOBALS['TL_LANG']['tl_c4g_map_profiles']['references_geosearch_engine']['4'] = 'con4gis support (<a href="https://con4gis.org/support" rel="noopener" target="_blank">usage policy</a>)';
...
$GLOBALS['TL_LANG']['tl_c4g_map_profiles']['references_geosearch_engine']['6'] = 'Stadia Maps (<a href="https://stadiamaps.com" rel="noopener" target="_blank">usage policy</a>)';

$GLOBALS['TL_LANG']['tl_c4g_map_profiles']['referencesOverpassEngine']['1'] = 'Custom overpass server';
$GLOBALS['TL_LANG']['tl_c4g_map_profiles']['referencesOverpassEngine']['2'] = 'con4gis support (<a href="https://con4gis.org/support" rel="noopener" target="_blank">usage policy</a>)';
...
$GLOBALS['TL_LANG']['tl_c4g_map_profiles']['initial_open_comp']['refs']['starboardscope'] = 'Elements in current scope';
