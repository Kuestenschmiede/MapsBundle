...
$GLOBALS['TL_LANG'][$strName]['drawCircle'] = ['Umkreis darstellen', 'Wählen Sie ob Sie den Umkreis darstellen wollen.'];
$GLOBALS['TL_LANG'][$strName]['areaCircleColor'] = ['Farbe des Umkreis', 'Wählen Sie die Farbe des Umkreis und die Opazität in %.'];
