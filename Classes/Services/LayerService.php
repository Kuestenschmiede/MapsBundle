...
class LayerService
{
    ...
    public function parseLayer($objLayer, $lang)
    {
        ...
        if ($objLayer->loc_minzoom > 0 || $objLayer->loc_maxzoom > 0) {
            $arrLayerData['zoom'] = [
                'min' => $objLayer->loc_minzoom > 0 ? $objLayer->loc_minzoom: false,
                'max' => $objLayer->loc_maxzoom > 0 ? $objLayer->loc_maxzoom: false,
    ...
    private function handleLayerLink($objLayer, $arrLayerData, $lang)
    {
        ...
        if ($linkedLayer->loc_minzoom > 0 || $linkedLayer->loc_maxzoom > 0) {
            $arrLayerData['zoom'] = [
                'min' => $linkedLayer->loc_minzoom > 0 ? $linkedLayer->loc_minzoom: false,
                'max' => $linkedLayer->loc_maxzoom > 0 ? $linkedLayer->loc_maxzoom: false,
