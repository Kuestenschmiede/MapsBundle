...
class TlC4gMapSettings extends \Backend
{
    public function addDefaultTables($dc){
        ...
        if(array_search('Table',$arrSettings) > -1){
            ...
            $strInsert = 'INSERT INTO tl_c4g_map_tables (name, tableSource, label, locstyle, popup, tooltip, tstamp, ptableCompareField, ptableField, ptableBlob, ptableOptions, ptable, geoy, geox) VALUES (\'tl_calendar_events\', \'tl_calendar_events\', \'c4g_loc_label\', \'c4g_locstyle\', null, \'title\', 1548082620, \'a:1:{i:0;s:14:"tl_calendar:id";}\', \'a:1:{i:0;s:3:"pid";}\', null, null, \'a:1:{i:0;s:11:"tl_calendar";}\', \'c4g_loc_geoy\', \'c4g_loc_geox\');';
